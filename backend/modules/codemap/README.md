...
Interactive code relationship visualization for DeepWiki. Extracts **file dependencies**, **function call graphs**, and **class hierarchies** from source code using AST parsing — no LLM calls, no embeddings, zero token cost.
