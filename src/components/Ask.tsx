...
const Ask: React.FC<AskProps> = ({
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* AI Disclaimer */}
      <div className="flex-shrink-0 px-4 pt-2 pb-0 flex items-center justify-center gap-1 text-[10px] text-[var(--muted)] opacity-50 select-none">
        ...
        <span>Responses generated by AI and may be inaccurate. Please double-check critical details.</span>
      </div>
