...
interface ModelSelectionModalProps {
  ...
  repositoryType?: 'github' | 'gitlab' | 'bitbucket' | 'azuredevops';
  // Authentication
...
export default function ModelSelectionModal({
  ...
  const [localSelectedPlatform, setLocalSelectedPlatform] = useState<'github' | 'gitlab' | 'bitbucket' | 'azuredevops'>(repositoryType);
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-screen items-center justify-center p-4 text-center bg-black/40 backdrop-blur-md">
        <div className="relative transform overflow-hidden rounded-2xl bg-[var(--card-bg)] text-left shadow-modal transition-all sm:my-8 sm:max-w-lg sm:w-full animate-slide-up">
