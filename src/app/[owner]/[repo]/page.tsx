              ...
              <div id="wiki-content" className="w-full flex-grow p-6 lg:p-8 overflow-y-auto">
                {currentPageId && generatedPages[currentPageId] ? (
                  <div className="max-w-[900px] xl:max-w-[1000px] mx-auto">
                    ...
                    {/* AI Disclaimer — inline badge below title */}
                    <div className="mb-4 flex items-center gap-1.5 text-[11px] text-[var(--muted)] select-none">
                      <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[var(--accent-primary)]/6 border border-[var(--accent-primary)]/10">
                        <svg className="w-3 h-3 text-[var(--accent-primary)] opacity-70" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                          <path d="M12 2L14.09 8.26L20 9.27L15.55 13.97L16.91 20L12 16.9L7.09 20L8.45 13.97L4 9.27L9.91 8.26L12 2Z" />
                        </svg>
                        <span className="opacity-75">Generated by AI — may contain errors. Please verify important information.</span>
                      </span>
                    </div>
